...
void CShader::setvec3(GLint location, vec3 v3) const{
...
int CShader::getuniformlocation(const char* name) const{
    return glGetUniformLocation(_program, name);
}

void CShader::setmat4(const char* name, const Mat4f &mat, GLboolean transpose) const{
    setmat4(getuniformlocation(name), mat, transpose);
}
void CShader::setvec3(const char* name, vec3 v3) const{
    setvec3(getuniformlocation(name), v3);
}
